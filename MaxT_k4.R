...
c<-replicate(4,fun4(40,50,60,40,0,0,0,0,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(40,50,60,40,1,1.1,1.2,1.3,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(40,50,60,40,1*1.5,1.1*1.5,1.2*1.5,1.3*1.5,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(40,50,60,40,1*2,1.1*2,1.2*2,1.3*2,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(40,50,60,40,1*2.5,1.1*2.5,1.2*2.5,1.3*2.5,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(40,50,60,40,1*3,1.1*3,1.2*3,1.3*3,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(40,50,60,40,1*3.5,1.1*3.5,1.2*3.5,1.3*3.5,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(40,50,60,40,1*4,1.1*4,1.2*4,1.3*4,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(40,50,60,40,1*4.5,1.1*4.5,1.2*4.5,1.3*4.5,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(40,50,60,40,1*5,1.1*5,1.2*5,1.3*5,4,1,2,3,4))
p=mean(c);p
...
c<-replicate(4,fun4(20,25,30,20,1,1.1,1.2,1.3,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(20,25,30,20,1*1.2,1.1*1.2,1.2*1.2,1.3*1.2,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(20,25,30,20,1*1.4,1.1*1.4,1.2*1.4,1.3*1.4,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(20,25,30,20,1*1.6,1.1*1.6,1.2*1.6,1.3*1.6,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(20,25,30,20,1*1.8,1.1*1.8,1.2*1.8,1.3*1.8,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(20,25,30,20,1*2,1.1*2,1.2*2,1.3*2,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(20,25,30,20,1*2.2,1.1*2.2,1.2*2.2,1.3*2.2,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(20,25,30,20,1*2.4,1.1*2.4,1.2*2.4,1.3*2.4,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(20,25,30,20,1*2.6,1.1*2.6,1.2*2.6,1.3*2.6,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(20,25,30,20,1*2.8,1.1*2.8,1.2*2.8,1.3*2.8,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(20,25,30,20,1*3,1.1*3,1.2*3,1.3*3,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(20,25,30,20,1*3.2,1.1*3.2,1.2*3.2,1.3*3.2,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(20,25,30,20,1*3.4,1.1*3.4,1.2*3.4,1.3*3.4,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(20,25,30,20,1*3.6,1.1*3.6,1.2*3.6,1.3*3.6,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(20,25,30,20,1*3.8,1.1*3.8,1.2*3.8,1.3*3.8,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(20,25,30,20,1*4,1.1*4,1.2*4,1.3*4,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(20,25,30,20,1*4.2,1.1*4.2,1.2*4.2,1.3*4.2,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(20,25,30,20,1*4.4,1.1*4.4,1.2*4.4,1.3*4.4,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(20,25,30,20,1*4.6,1.1*4.6,1.2*4.6,1.3*4.6,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(20,25,30,20,1*4.8,1.1*4.8,1.2*4.8,1.3*4.8,4,1,2,3,4))
p=mean(c);p
c<-replicate(4,fun4(20,25,30,20,1*5,1.1*5,1.2*5,1.3*5,4,1,2,3,4))
p=mean(c);p
...
c<-replicate(4,fun4(30,25,20,15,0.1,0.3,0.4,0.5,2,1,1,1,1))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*1.2,0.3*1.2,0.4*1.2,0.5*1.2,2,1,1,1,1))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*1.4,0.3*1.4,0.4*1.4,0.5*1.4,2,1,1,1,1))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*1.6,0.3*1.6,0.4*1.6,0.5*1.6,2,1,1,1,1))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*1.8,0.3*1.8,0.4*1.8,0.5*1.8,2,1,1,1,1))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*2,0.3*2,0.4*2,0.5*2,2,1,1,1,1))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*2.2,0.3*2.2,0.4*2.2,0.5*2.2,2,1,1,1,1))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*2.4,0.3*2.4,0.4*2.4,0.5*2.4,2,1,1,1,1))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*2.6,0.3*2.6,0.4*2.6,0.5*2.6,2,1,1,1,1))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*2.8,0.3*2.8,0.4*2.8,0.5*2.8,2,1,1,1,1))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*3,0.3*3,0.4*3,0.5*3,2,1,1,1,1))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*3.2,0.3*3.2,0.4*3.2,0.5*3.2,2,1,1,1,1))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*3.4,0.3*3.4,0.4*3.4,0.5*3.4,2,1,1,1,1))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*3.6,0.3*3.6,0.4*3.6,0.5*3.6,2,1,1,1,1))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*3.8,0.3*3.8,0.4*3.8,0.5*3.8,2,1,1,1,1))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*4,0.3*4,0.4*4,0.5*4,2,1,1,1,1))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*4.2,0.3*4.2,0.4*4.2,0.5*4.2,2,1,1,1,1))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*4.4,0.3*4.4,0.4*4.4,0.5*4.4,2,1,1,1,1))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*4.6,0.3*4.6,0.4*4.6,0.5*4.6,2,1,1,1,1))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*4.8,0.3*4.8,0.4*4.8,0.5*4.8,2,1,1,1,1))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*5,0.3*5,0.4*5,0.5*5,2,1,1,1,1))
crit_value=sum(c)/4;crit_value


c<-replicate(4,fun4(30,25,20,15,0,0,0,0,2,1,2,3,4))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1,0.3,0.4,0.5,2,1,2,3,4))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*1.2,0.3*1.2,0.4*1.2,0.5*1.2,2,1,2,3,4))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*1.4,0.3*1.4,0.4*1.4,0.5*1.4,2,1,2,3,4))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*1.6,0.3*1.6,0.4*1.6,0.5*1.6,2,1,2,3,4))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*1.8,0.3*1.8,0.4*1.8,0.5*1.8,2,1,2,3,4))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*2,0.3*2,0.4*2,0.5*2,2,1,2,3,4))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*2.2,0.3*2.2,0.4*2.2,0.5*2.2,2,1,2,3,4,1))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*2.4,0.3*2.4,0.4*2.4,0.5*2.4,2,1,2,3,4))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*2.6,0.3*2.6,0.4*2.6,0.5*2.6,2,1,2,3,4))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*2.8,0.3*2.8,0.4*2.8,0.5*2.8,2,1,2,3,4))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*3,0.3*3,0.4*3,0.5*3,2,1,2,3,4))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*3.2,0.3*3.2,0.4*3.2,0.5*3.2,2,1,2,3,4))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*3.4,0.3*3.4,0.4*3.4,0.5*3.4,2,1,2,3,4))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*3.6,0.3*3.6,0.4*3.6,0.5*3.6,2,1,2,3,4))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*3.8,0.3*3.8,0.4*3.8,0.5*3.8,2,1,2,3,4))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*4,0.3*4,0.4*4,0.5*4,2,1,2,3,4))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*4.2,0.3*4.2,0.4*4.2,0.5*4.2,2,1,2,3,4))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*4.4,0.3*4.4,0.4*4.4,0.5*4.4,2,1,2,3,4))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*4.6,0.3*4.6,0.4*4.6,0.5*4.6,2,1,2,3,4))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*4.8,0.3*4.8,0.4*4.8,0.5*4.8,2,1,2,3,4))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(30,25,20,15,0.1*5,0.3*5,0.4*5,0.5*5,2,1,2,3,4))
crit_value=sum(c)/4;crit_value
...
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(5,7,10,15,0,0,0,0,2,4,3,2,1))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(5,7,10,15,0,0,0,0,2,0.1,0.2,0.3,0.4))
crit_value=sum(c)/4;crit_value
c<-replicate(4,fun4(5,7,10,15,0,0,0,0,2,0.1,1,0.5,2))
crit_value=sum(c)/4;crit_value
...
c<-replicate(4,fun4(10,15,10,15,1*2.4,1.2*2.4,1.2*2.4,1.6*2.4,2,1,1,1,1))
crit_value=sum(c)/4;crit_value
