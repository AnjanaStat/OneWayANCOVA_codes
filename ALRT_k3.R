...
fun1<-function(n1,n2,n3,a1,a2,a3,b,v1,v2,v3)
{
  ...
  LR=((s1/S01)^(n1/2))*((s2/S02)^(n2/2))*((s3/S03)^(n3/2))
  value=-2*log(LR)
  return(value)
}
fun4<-function(n1,n2,n3,a1,a2,a3,b,v1,v2,v3)
{
  # find 10000 values of -2log(lambda) from fun1
  X<-replicate(10000,fun1(n1,n2,n3,a1,a2,a3,b,v1,v2,v3))
